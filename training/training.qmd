...
<!-- | Introduction to R for Modellers | 23 April 2024 – 24 May 2024 | [Next event: Apply to join](https://forms.office.com/e/vP1a5Pc2tg){.btn-action-primary .btn-action .btn .btn-success .btn-sm role="button"} | -->

| Courses  | Dates | Join or Subscribe |
|:--------|:--------|:------|
| Introduction to R for Modellers | 23 April 2024 – 24 May 2024 | [Past event: Course Completed](){.btn .btn-secondary .btn-sm role="button"} |
| Infectious Disease Modelling in Context: Introduction | 7 June 2024 – 5 July 2024 | [Past event: Course Completed](){.btn .btn-secondary .btn-sm role="button"} |
| Infectious Disease Modelling in Context: Intermediate | 19 July 2024 – 16 August 2024 | [Current event: Application Closed](){.btn .btn-secondary .btn-sm role="button"} |


<!-- | Infectious Disease Modelling in Context: Intermediate | 19 July 2024 – 16 August 2024 | [Next event: Apply to join](https://forms.office.com/e/y3qhkF17sD){.btn-action-primary .btn-action .btn .btn-success .btn-sm role="button"} | -->

<!-- | Infectious Disease Modelling in Context: Intermediate | 19 July 2024 – 16 August 2024 | [Future event: Subscribe to be notified](https://forms.office.com/e/TAjR6QQA1E){.btn-action-primary .btn-action .btn .btn-success .btn-sm role="button"} | -->


:::
:::

<!-- section 3: courses and leads -->
...
Please read our [pricing policy](Training_Programme_Pricing_Policy_March_2024_Final.pdf).
...
<!-- [Apply to join Introduction to R for Modellers]{.btn-action-secondary .btn-action .btn .btn-secondary .btn-lg role="button"} -->

<!-- [Apply to join Introduction to R for Modellers](https://forms.office.com/e/vP1a5Pc2tg){.btn-action-primary .btn-action .btn .btn-success .btn-lg role="button disabled"} -->

All of our current and future courses are closed for registration. Please leave your details after clicking the subscribe button below, and we will let you know when application re-opens.
...
For further information contact [tracy.evans@ndm.ox.ac.uk](mailto:tracy.evans@ndm.ox.ac.uk).

We also provide bespoke versions of this course for organisations. Please [contact us](mailto:tracy.evans@ndm.ox.ac.uk) if you would like to discuss this opportunity further.
