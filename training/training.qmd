...
|:--------|:--------|:------|
| Introduction to R for Modellers | 23 April 2024 – 24 May 2024 | [Current event](){.btn .btn-secondary .btn-sm role="button"} |
| Infectious Disease Modelling in Context: Introduction | 7 June 2024 – 5 July 2024 | [Next event: Apply to join](https://forms.office.com/e/AkvKct7N6Z){.btn-action-primary .btn-action .btn .btn-success .btn-sm role="button"} |
